					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
							<div class="progress-box text-center">
								...
								<h5 class="text-light-green padding-top-10 weight-500">Total Registered Chef </h5>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
							<div class="progress-box text-center">
								...
								<h5 class="text-light-orange padding-top-10 weight-500">Total Customer</h5>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
							<div class="progress-box text-center">
								...
								<h5 class="text-light-purple padding-top-10 weight-500">Total Dishes</h5>
				...
				<div class="row">
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-30">
						<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
							<div class="progress-box text-center">
								<h5 class="text-light-purple padding-top-10 weight-500">Monthly  Orders</h5>
					...
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-30">
						<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
							<div class="progress-box text-center">
								<h5 class="text-light-purple padding-top-10 weight-500">Today Order </h5>
					...
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-30">
						<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
							<div class="progress-box text-center">
								<h5 class="text-light-purple padding-top-10 weight-500">Complete Orders</h5>
					...
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-30">
						<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
							<div class="progress-box text-center">
								<h5 class="text-light-purple padding-top-10 weight-500">Pending Order</h5>
