				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
						<div class="progress-box text-center">
							...
							<h5 class="text-blue padding-top-10 weight-500">Total Member</h5>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
						<div class="progress-box text-center">
							...
							<h5 class="text-light-green padding-top-10 weight-500">Total Complain</h5>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
						<div class="progress-box text-center">
							...
							<h5 class="text-light-orange padding-top-10 weight-500">Total Building</h5>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
						<div class="progress-box text-center">
							...
							<h5 class="text-light-purple padding-top-10 weight-500">Request For Add New Member</h5>
