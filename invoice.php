					...
					<div class="invoice-box">
						...
						<div class="row pb-30">
							<div class="col-md-6">
								...
								<p class="font-14 mb-5">Date Issued: <strong class="weight-600">1 Oct 2019</strong></p>
								<p class="font-14 mb-5">Invoice No: <strong class="weight-600">4556</strong></p>
							</div>
							<div class="col-md-6">
								<div class="text-right">
									<p class="font-14 mb-5">Niraj Kumar </strong></p>
									<p class="font-14 mb-5">306 Hir- Asha Arcade, Sola</p>
									<p class="font-14 mb-5">Ahmedabad</p>
									<p class="font-14 mb-5">368020</p>
								</div>
							</div>
						</div>
						<div class="invoice-desc pb-30">
							...
							<div class="invoice-desc-body">
								<ul>
									<li class="clearfix">
										<div class="invoice-sub">Gas Bill</div>
									...
									<li class="clearfix">
										<div class="invoice-sub">Light Bill</div>
										<div class="invoice-rate">$20</div>
										<div class="invoice-hours">100</div>
										<div class="invoice-subtotal"><span class="weight-600">$2000</span></div>
									</li>
									<li class="clearfix">
										<div class="invoice-sub">Water Bill</div>
										<div class="invoice-rate">$20</div>
										<div class="invoice-hours">100</div>
										<div class="invoice-subtotal"><span class="weight-600">$2000</span></div>
									</li>
									<li class="clearfix">
										<div class="invoice-sub">Other Design</div>
										<div class="invoice-rate">$20</div>
										<div class="invoice-hours">100</div>
										<div class="invoice-subtotal"><span class="weight-600">$2000</span></div>
									</li>
								...
								<div class="invoice-desc-body">
									<ul>
										<li class="clearfix">
											...
											<div class="invoice-rate font-20 weight-600">10 Oct 2019</div>
