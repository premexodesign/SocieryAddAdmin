			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="chefdashboard.php">Dashboard </a></li>
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-home"></span><span class="mtext">Specialization</span>
						</a>
						<ul class="submenu">
							<li><a href="dishes.php">Add Recipe </a></li>
							<li><a href="recipedetails.php">View  Recipe Details </a></li>
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-home"></span><span class="mtext">Customer</span>
						</a>
						<ul class="submenu">
							<li><a href="addCustomer.php">Add Customer </a></li>
							<li><a href="customerdetails.php">Customer Details  </a></li>
							<li><a href="customerdetails.php">Frequent Customer </a></li>
							<li><a href="customerdetails.php"> Customer Feedback</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
						...
						<ul class="submenu">
							<li><a href="addOrder.php">Add Order Details</a></li>
							<li><a href="orderdetails.php?id=all">Order Details</a></li>
							<li><a href="orderdetails.php?id=pending">Pending Order</a></li>
							<li><a href="orderdetails.php?id=done">Complete Order</a></li>
				...
				<!--	<li class="dropdown">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-table"></span><span class="mtext">Payment</span>
						</a>
						<ul class="submenu">
...
<!--
				<li class="dropdown">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-desktop"></span><span class="mtext"> Refered Customer </span>
						</a>
						<ul class="submenu">
							<li><a href="referedCustomer.php">Refered Customer</a></li>
...
<!--
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-paint-brush"></span><span class="mtext">Disputed Details</span>
						</a>
						<ul class="submenu">
							<li><a href="disputedDetails.php">Disputed Customer</a></li>
							<li><a href="disputedDetails.php">Disputed Chef</a></li>
...
-->
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-plug"></span><span class="mtext">Conversation </span>
						</a>
						<ul class="submenu">
							<li><a href="conversation.php">Conversation between Chef and Customer</a></li>
							<li><a href="conversation.php">Conversation between Chef and Chef</a></li>
							<li><a href="conversation.php">Conversation between Admin and Chef</a></li>
							<li><a href="uploadConversation.php">Upload Conversation</a></li>
