...
?>
	<div class="main-container">
		...
		<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						<h4 class="text-blue">Bill wizard</h4>
						<p class="mb-30 font-14">Bill </p>
					</div>
					<div class="wizard-content">
						<form class="tab-wizard wizard-circle wizard"  method="post" action="function.php">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="date" class="form-control" name="mem_pan_card_no">
										</div>
									</div>
								</div>
							...
							<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<input  type="hidden" name="reg" value="bill" />
											<input  type="submit" name="" value="Generate Bill" class="btn btn-primary" />
										</div>
									</div>
							</div>
							<!-- Step 3 -->
