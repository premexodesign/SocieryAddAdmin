       ...
       echo date("Y-M-D");
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Society Data Table </h5>
					...
					<div class="row">
						...
						<table class="stripe hover multiple-select-row data-table-export nowrap">
							<thead>
								<tr>
									<th class="table-plus datatable-nosort">Society No.</th>
									<th>Society Name</th>
									<th>City</th>
            ...
            <div class="modal-body">
                ...
                <form role="form">
                    <div class="form-group">
                        <label for="inputName">Society No.:</label>
                        <input type="text" class="form-control" id="inputName" placeholder="Enter your name"/>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail">Society Name</label>
                        <input type="text" class="form-control" id="inputEmail" placeholder="Enter Society Name"/>
                    </div>
                    <div class="form-group">
                        <label for="inputMessage">Society Address</label>
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputEmail" placeholder="Enter Pin Code"/>
                    </div>
					 <div class="form-group">
                        <label for="inputEmail">Contact No.</label>
                        <input type="text" class="form-control" id="inputEmail" placeholder="Enter Contact No."/>
                    </div>
                    
                     <div class="form-group">
                        <label for="inputEmail">Upload Society Pics</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">View  Society Details</h4>
            </div>
