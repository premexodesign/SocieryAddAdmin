...
<body>
	...
	//$usertype=$_SESSION['usertype'];
	 include('include/ownersidebar.php');
					...
					<div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 mb-30">
						<div class="pd-20 bg-white border-radius-4 box-shadow">
							<div class="profile-photo">
								...
								<img  src="images/<?php echo $row[8] ?>" alt="" class="avatar-photo">
								<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											<div class="modal-body pd-5">
												<div class="img-container">
													<img id="image"  src="images/<?php echo $row[7] ?>" alt="Picture">
												</div>
											</div>
							...
							<h5 class="text-center"><?php echo $row[2]?></h5>
