				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<div class="row">
						...
						<table class="stripe hover multiple-select-row data-table-export nowrap">
							<thead>
								<tr>
									<th class="table-plus datatable-nosort">Service Code</th>
									<th>Service Name</th>
									<th>Service Type</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form">
                    ...
                    <div class="form-group">
                        <label for="inputMessage">Service Code: </label>
                        <input type="text" class="form-control" id="inputMessage" placeholder="Enter Service Code"/>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputName" placeholder="Enter Service Name"/>
                    </div>
					
					<div class="form-group">
                        <label for="inputName">Service Provider Name:</label>
                        <input type="text" class="form-control" id="inputName" placeholder="Enter Service Provider Name"/>
                    </div>
					<div class="form-group">
