       ...
       echo date("Y-M-D");
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Wing Data Table </h5>
					...
					<div class="row">
						...
						<table class="stripe hover multiple-select-row data-table-export nowrap">
							<thead>
								<tr>
									<th class="table-plus datatable-nosort">Society Name</th>
									<th>Wing Name</th>
									<th>No. Of Floor</th>
									<th>No. Of House</th>
									<th>Contact No</th>
                ...
                <form role="form">
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputMessage" placeholder="Enter wing name"/>
                    </div>
                    <div class="form-group">
                        <label for="inputMessage">No. of Floor In A Wing </label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">View Wing</h4>
            </div>
